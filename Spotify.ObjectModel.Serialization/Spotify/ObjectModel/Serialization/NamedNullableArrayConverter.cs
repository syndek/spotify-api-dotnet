...
{
    public sealed class NamedNullableArrayConverter<TElement> : JsonConverter<IReadOnlyList<TElement?>> where TElement : class
    {
        public static readonly NamedNullableArrayConverter<TElement> Instance = new();
