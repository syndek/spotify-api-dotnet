...
namespace Spotify.ObjectModel.Serialization
{
    ...
    /// </summary>
    public static class ConverterHelpers : Object
    {
        ...
        static ConverterHelpers()
        {
            ...
            converters.Add(PlaylistConverter.Instance);
            converters.Add(PlaylistTrackConverter.Instance);
        ...
        public static Uri ReadUri(ref this Utf8JsonReader reader)
        {
            reader.Read(JsonTokenType.String);
            return new(reader.GetString()!);
        }

        public static Uri? ReadNullableUri(ref this Utf8JsonReader reader)
        {
            reader.Read();
        ...
        public static IReadOnlyList<TObject> ReadArray<TObject>(ref this Utf8JsonReader reader) =>
            ArrayConverter<TObject>.Instance.Read(ref reader, typeof(IReadOnlyList<TObject>), ConverterHelpers.JsonSerializerOptions);

        public static Paging<TObject> ReadPaging<TObject>(ref this Utf8JsonReader reader) =>
            PagingConverter<TObject>.Instance.Read(ref reader, typeof(Paging<TObject>), ConverterHelpers.JsonSerializerOptions);

        public static IReadOnlyDictionary<String, String> ReadStringDictionary(ref this Utf8JsonReader reader)
        {
        ...
        public static IReadOnlyDictionary<String, Uri> ReadExternalUrls(ref this Utf8JsonReader reader)
        {
            reader.AssertTokenType(JsonTokenType.StartObject);
        ...
        public static IReadOnlyList<CountryCode> ReadCountryCodeArray(ref this Utf8JsonReader reader)
        {
