...
namespace Spotify.ObjectModel
{
    ...
    public record Artist : SimplifiedArtist
    {
        ...
        /// </param>
        /// <param name="popularity">An <see cref="Int32"/> representing the popularity of the artist.</param>
        ...
        /// </summary>
        /// <returns>An <see cref="Int32"/> representing the popularity of the <see cref="Artist"/>.</returns>
